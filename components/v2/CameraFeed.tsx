...
/**
 * Compact "no signal" camera strip. Fills its parent height — the page
 * controls how tall it is. Phase 3 wires the live MJPEG stream here.
 */
export function CameraFeed() {
  return (
    ...
    >
      <div className="relative w-full h-full zip-v2-scanlines zip-v2-grain zip-hatch overflow-hidden">
